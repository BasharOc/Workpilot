import { LogOut, User as UserIcon, Mail, CalendarDays } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-lg space-y-6 px-4 py-10">
      ...
      <div className="rounded-xl border border-border bg-card p-5">
        ...
        <button
          onClick={() => void logout()}
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-red-200 bg-red-50 px-4 py-2.5 text-sm font-medium text-red-600 transition hover:bg-red-100"
        >
